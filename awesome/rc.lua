...
beautiful.init("/home/clemens/.config/awesome/tango_dark.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "XF86AudioPlay",
       function () awful.util.spawn("mpc toggle") end),
    awful.key({}, "XF86AudioStop",
       function () awful.util.spawn("mpc stop") end),
    awful.key({}, "XF86AudioNext",
       function () awful.util.spawn("mpc next") end),
    awful.key({}, "XF86AudioPrev",
       function () awful.util.spawn("mpc prev") end),
    awful.key({"Shift"}, "XF86AudioPrev",
       function () awful.util.spawn("mpc del 0") end),
    ...
    awful.key({ }, "XF86AudioRaiseVolume", 
       function () awful.util.spawn("amixer -D pulse sset Master 3%+") end),
